...
@section('content')
	<main id="main" class="main">
		...
		<section class="section dashboard">
			<div class="row">
				<div class="col-md-12">
					<form action="{{ route('network.store') }}" id="regform" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
						@csrf
						<div class="box box-info">
							<div class="box-body">
								<div class="form-group mb-3">
									...
									<div class="col-sm-9">
										<input type="text" autocomplete="off" class="form-control" name="title" value="{{ old('title') }}" placeholder="Enter network title">
								...
								<div class="form-group mb-3">
									...
									<div class="col-sm-1">
										<input type="color" autocomplete="off" class="form-control" name="color" value="{{ old('color') }}" placeholder="Enter company color">
...
@push('js')
<script>
	white_bg_logo.onchange = evt => {
		const [file] = white_bg_logo.files
		if (file) {
			white_bg_preview.src = URL.createObjectURL(file)
		}
	}

	black_bg_logo.onchange = evt => {
		const [file] = black_bg_logo.files
		if (file) {
			black_bg_preview.src = URL.createObjectURL(file)
		}
	}
