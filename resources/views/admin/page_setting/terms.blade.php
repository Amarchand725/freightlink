						...
						<div class="box box-info">
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<textarea class="form-control" name="terms_conditions" style="height:220px;" placeholder="Enter terms & conditions here">{!! isset($page_data['terms_conditions'])?$page_data['terms_conditions']:'' !!}</textarea>
									</div>
								</div>
								<div class="form-group">
									<label for="" class="col-sm-2 control-label">Privacy Policies </label>
									<div class="col-sm-9">
										<textarea class="form-control" name="privacy_policies" style="height:220px;" placeholder="Enter privacy policies here">{!! isset($page_data['privacy_policies'])?$page_data['privacy_policies']:'' !!}</textarea>
									</div>
								</div>
								<div class="form-group">
