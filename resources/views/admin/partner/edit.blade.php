...
@section('content')
	<main id="main" class="main">
		...
		<section class="section dashboard">
			<div class="row">
				<div class="col-md-12">
					<form action="{{ route('partner.update', $model->slug) }}" id="regform" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
						@csrf
						{{ method_field('PATCH') }}
						<div class="box box-info">
							<div class="box-body">
								<div class="form-group mb-3">
									...
									<div class="col-sm-9">
										<input type="text" autocomplete="off" class="form-control" name="name" value="{{ $model->name }}" placeholder="Enter company name">
								...
								@if($model->image)
									<div class="form-group mb-3">
										...
										<div class="col-sm-9" style="padding-top:5px">
											<img src="{{ asset('public/admin/images/partners') }}/{{ $model->image }}" alt="Post" height="30%" width="30%">
										</div>
									</div>
								@endif
								<div class="form-group mb-3">
