...
@section('content')
	<main id="main" class="main">
		...
		<section class="section dashboard">
			<div class="row">
				<div class="col-md-12">
					<form action="{{ route('faq.update', $model->id) }}" id="regform" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
						@csrf
						{{ method_field('PATCH') }}
						<div class="box box-info">
							<div class="box-body">
								<div class="form-group mb-3">
									...
									<div class="col-sm-9">
										<input type="text" autocomplete="off" class="form-control" name="question" value="{{ $model->question }}" placeholder="Enter question">
								...
								<div class="form-group mb-3">
									...
									<div class="col-sm-9">
										<textarea class="form-control texteditor" name="answer" style="height:200px;" placeholder="Enter answer">{{ $model->answer }}</textarea>
