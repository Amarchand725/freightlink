						...
						<div class="box box-info">
							<div class="box-body">
								<div class="form-group mb-3">
									...
									<div class="col-sm-9">
										<input type="text" autocomplete="off" class="form-control" name="question" value="{{ old('question') }}" placeholder="Enter company question">
								...
								<div class="form-group mb-3">
									...
									<div class="col-sm-9">
										<textarea class="form-control texteditor" name="answer" style="height:200px;" placeholder="Enter answer">{{ old('answer') }}</textarea>
