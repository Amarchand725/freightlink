		...
		<section class="section dashboard" style="background: #FCFCFC;">
            <section class="section faq">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <form class="form-inline" action="{{ route('company.update', $model->id) }}" method="post" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                @csrf
								{{ method_field('PATCH') }}
                                    ...
                                    <div class="col-lg-12 mrl_head">
                                        <div class="row label_forms">
                                            <div class="col-3 frm_st">
                                                <input type="text" class="form-control" value="{{ $model->name }}" name="company_name" id="company_name"  placeholder="Company Name">
                                            ...
                                            <div class="col-2">
                                                <div class="form-check form-switch">
													...
													@if($model->new_member)
														<input class="form-check-input bg-success" name="new_member" value="1" type="checkbox" role="switch"  id="new-member" checked/>
													@else 
                                                    	<input class="form-check-input bg-danger" name="new_member" value="1" type="checkbox" role="switch"  id="new-member" />
													@endif
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-check form-switch">
													...
													@if($model->suspended)
                                                    	<input class="form-check-input bg-success" name="suspended" value="1" type="checkbox" role="switch" id="suspended" checked />
													@else 
                                            ...
                                            <div class="col">
                                                <div class="form-check form-switch">
													...
													@else 
														<input class="form-check-input bg-danger" name="status" value="1" type="checkbox" role="switch" id="status" />
													@endif
                                                </div>
                                            </div>
                                            <div class="col-2">
                                                <div class="form-check form-switch">
													...
													@else 
														<input class="form-check-input bg-danger" name="on_website" value="1" type="checkbox" role="switch" id="on_website" />
													@endif
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-3" style="position: relative">
                                        <div class="file-drop-area">
											@if(!empty($model->logo))
												<img id="logo_preview" src="{{ asset('public/admin/images/companies') }}/{{ $model->logo }}" alt="folder-icon" class="img-fluid">
											@else 
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" name="address_line_one" value="{{ $address[0] }}" class="form-control form-control-sm" id="colFormLabelSm" placeholder="Line 1">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <input type="date" value="{{ $model->enrollment_date }}" name="enrollment_date" class="form-control">
														<span style="color: red">{{ $errors->first('enrollment_date') }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" name="address_line_two" value="{{ $address[1] }}" class="form-control form-control-sm" id="colFormLabelSm" placeholder="Line 2">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <input type="date" value="{{ $model->expiry_date }}" name="expiry_date" class="form-control">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" name="address_line_three" value="{{ $address[2] }}" class="form-control form-control-sm" id="colFormLabelSm" placeholder="Line 3">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <input type="text" name="country" value="{{ $model->country }}" class="form-control" placeholder="Enter country name">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" name="website" value="{{ $model->website }}" class="form-control form-control-sm" id="colFormLabelSm" placeholder="Website">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <input type="text" name="city" value="{{ $model->city }}" class="form-control" placeholder="Enter city name">
														<span style="color: red">{{ $errors->first('city') }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12 d-flex justify-content-end">
                                                <button type="submit" name="save" value="basic" class="btn btn-primary buttons_green ">
                                                    Save Changes
                                                </button>
                                            </div>
                                        </div>
						...
						<form class="form-inline" action="{{ route('company.update', $model->id) }}" method="post" enctype="multipart/form-data" method="post" accept-charset="utf-8">
							...
							<div class="row py-4">
								@foreach ($networks as $network)
									<div class="col">
										<div class="form-check form-switch">
											@if(networkStatus($model->id, $network->id))
											...
											@else 
												<input class="form-check-input bg-danger" type="checkbox" name="networks[{{ $network->id }}]" value="1" role="switch" id="flexSwitchCheckChecked">
											@endif 
										</div>
									</div>
								@endforeach

								<span style="color: red">{{ $errors->first('networks') }}</span>
								
								<div class="col-md-12 d-flex justify-content-end pt-3">
									<button type="submit" name="save" value="network" class="btn btn-primary buttons_green ">
										Save Changes
									</button>
								</div>
							</div>
										...
										<div class="col-lg-12 mrl_head">
											<form action="#">
												<div class="form-group">
													<textarea class="form-control texteditor" name="company_profile" id="" rows="8" placeholder="Enter company profile content here...">{{ $model->profile }}</textarea>
													<span style="color: red">{{ $errors->first('company_profile') }}</span>
												</div>
												<div class="pt-5 d-flex justify-content-end ">
													<button style="submit" name="save" value="profile" class="btn btn-primary buttons_green  ">Save Changes</button>
												</div>
											</form>
										</div>
									</div>
